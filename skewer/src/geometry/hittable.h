...
// #define HITTABLE_H
// //==============================================================================================
// // Abstract base class for objects that can be hit by rays.
// // Includes transform classes (translate, rotate_y) for positioning objects.
// //==============================================================================================
...
//         auto origin =
//             point3((cos_theta * r.origin().x()) - (sin_theta * r.origin().z()), r.origin().y(),
...
//         rec.normal =
//             vec3((cos_theta * rec.normal.x()) + (sin_theta * rec.normal.z()), rec.normal.y(),

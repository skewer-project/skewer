...
public:
    ...
    triangle(const point3& v0, const point3& v1, const point3& v2, shared_ptr<material> mat)
        : v0(v0), v1(v1), v2(v2), mat(mat),
          has_vertex_normals(false), has_uvs(false)
    {
    ...
    triangle(const point3& v0, const point3& v1, const point3& v2,
        ...
        : v0(v0), v1(v1), v2(v2), mat(mat),
          n0(unit_vector(n0)), n1(unit_vector(n1)), n2(unit_vector(n2)),
          has_vertex_normals(true), has_uvs(false)
    {
    ...
    bool hit(const ray& r, interval ray_t, hit_record& rec) const override
    {
        ...
        // Compute barycentric coordinates: w = 1 - u - v, where (w, u, v) correspond to (v0, v1, v2)
        double w = 1.0 - u - v;

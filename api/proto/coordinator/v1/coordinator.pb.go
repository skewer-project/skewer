...
const file_coordinator_v1_coordinator_proto_rawDesc = "" +
	...
	"\facknowledged\x18\x01 \x01(\bR\facknowledged2\xca\x03\n" +
	...
	"\tCancelJob\x12*.api.proto.coordinator.v1.CancelJobRequest\x1a+.api.proto.coordinator.v1.CancelJobResponse\x12y\n" +
...
var file_coordinator_v1_coordinator_proto_goTypes = []any{
	...
	(*WorkPackage)(nil),                 // 9: api.proto.coordinator.v1.WorkPackage
	(*RenderTask)(nil),                  // 10: api.proto.coordinator.v1.RenderTask
	(*CompositeTask)(nil),               // 11: api.proto.coordinator.v1.CompositeTask
...
var file_coordinator_v1_coordinator_proto_depIdxs = []int32{
	...
	10, // 3: api.proto.coordinator.v1.WorkPackage.render_task:type_name -> api.proto.coordinator.v1.RenderTask
	11, // 4: api.proto.coordinator.v1.WorkPackage.composite_task:type_name -> api.proto.coordinator.v1.CompositeTask
	...
	12, // 8: api.proto.coordinator.v1.CoordinatorService.ReportTaskResult:input_type -> api.proto.coordinator.v1.ReportTaskResultRequest
	4,  // 9: api.proto.coordinator.v1.CoordinatorService.SubmitJob:output_type -> api.proto.coordinator.v1.SubmitJobResponse
	6,  // 10: api.proto.coordinator.v1.CoordinatorService.GetJobStatus:output_type -> api.proto.coordinator.v1.GetJobStatusResponse
	8,  // 11: api.proto.coordinator.v1.CoordinatorService.CancelJob:output_type -> api.proto.coordinator.v1.CancelJobResponse
	13, // 12: api.proto.coordinator.v1.CoordinatorService.ReportTaskResult:output_type -> api.proto.coordinator.v1.ReportTaskResultResponse

...
type RenderJob struct {
	...
	MinSamples     int32   `protobuf:"varint,8,opt,name=min_samples,json=minSamples,proto3" json:"min_samples,omitempty"`       // Minimum samples before convergence check (default 0 = use scene JSON)
	AdaptiveStep   int32   `protobuf:"varint,9,opt,name=adaptive_step,json=adaptiveStep,proto3" json:"adaptive_step,omitempty"` // Samples between convergence checks (default 0 = use scene JSON)
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type RenderTask struct {
	...
	NoiseThreshold float32 `protobuf:"fixed32,9,opt,name=noise_threshold,json=noiseThreshold,proto3" json:"noise_threshold,omitempty"`
	MinSamples     int32   `protobuf:"varint,10,opt,name=min_samples,json=minSamples,proto3" json:"min_samples,omitempty"`
	AdaptiveStep   int32   `protobuf:"varint,11,opt,name=adaptive_step,json=adaptiveStep,proto3" json:"adaptive_step,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ReportTaskResultRequest) Reset() {
	*x = ReportTaskResultRequest{}
	mi := &file_coordinator_v1_coordinator_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReportTaskResultRequest) Descriptor() ([]byte, []int) {
	return file_coordinator_v1_coordinator_proto_rawDescGZIP(), []int{13}
}
...
func (x *ReportTaskResultResponse) Reset() {
	*x = ReportTaskResultResponse{}
	mi := &file_coordinator_v1_coordinator_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReportTaskResultResponse) Descriptor() ([]byte, []int) {
	return file_coordinator_v1_coordinator_proto_rawDescGZIP(), []int{14}
}
...
const file_coordinator_v1_coordinator_proto_rawDesc = "" +
	...
	"minSamples\x12#\n" +
	"\radaptive_step\x18\t \x01(\x05R\fadaptiveStep\"h\n" +
	"\fCompositeJob\x12,\n" +
	...
	"enableDeep\x12\x18\n" +
	"\athreads\x18\b \x01(\x05R\athreads\x12'\n" +
	"\x0fnoise_threshold\x18\t \x01(\x02R\x0enoiseThreshold\x12\x1f\n" +
	"\vmin_samples\x18\n" +
	" \x01(\x05R\n" +
	"minSamples\x12#\n" +
	"\radaptive_step\x18\v \x01(\x05R\fadaptiveStep\"]\n" +
	"\tMergeTask\x121\n" +
...
var file_coordinator_v1_coordinator_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
...
func file_coordinator_v1_coordinator_proto_init() {
	...
	file_coordinator_v1_coordinator_proto_msgTypes[9].OneofWrappers = []any{
